...
import { Beaker, Palette, Briefcase } from 'lucide-react';
...
export function Scene2() {
  ...
  const archetypes = [
    { icon: <Beaker size="4vw" />, title: "STEM", delay: 0 },
    { icon: <Palette size="4vw" />, title: "ARTS", delay: 0.2 },
    { icon: <Briefcase size="4vw" />, title: "BUSINESS", delay: 0.4 },
  ];
