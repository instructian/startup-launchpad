...
import { ChevronDown, Search, X, Printer } from "lucide-react";

// ── Data ────────────────────────────────────────────────────────────────────

type FAQItem = { q: string; a: string };
type Section = { id: string; label: string; icon: string; color: string; faqs: FAQItem[] };
...
const SECTIONS: Section[] = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "The Ideathon is a fall event where teams present a 90-second idea pitch to judges and peers. Participating is strongly encouraged — the pitch experience, judge feedback, and peer networking are core to the program's learning model. It is not a winner-takes-all competition; it is a milestone checkpoint where you receive structured feedback to improve your project.",
      },
      {
        q: "What is the Innovation Festival and who can attend?",
        a: "The Innovation Festival is a spring showcase where teams present at a more developed stage — a 3-minute validation pitch in Year 1, or a 7–10 minute venture pitch with Q&A in Year 2. It is open to the public and attended by students, faculty, alumni, mentors, and industry guests. Year 2 Innovation Festival presentations serve as the qualifier for Sunstone.",
      },
      {
        q: "What is Sunstone and how do I qualify?",
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        q: "What is the Launchpad tool and how does our team use it?",
        a: "The Launchpad tool is the program's central training and project-development system. Your team uses it to define your problem and customer, log customer interview evidence, track hypotheses and experiments, document business model assumptions, map team roles, build pitch materials, and plan your next sprint based on judge feedback. Consistent tool use is part of what makes your evidence visible to mentors and judges.",
      },
      {
        q: "How does judging work at each event?",
        a: "Judging rubrics are explicitly weighted toward evidence, validation, learning, and traction — not pitch polish or presentation quality. At early stages, judges reward problem clarity, customer insight, and team potential. At later stages, they look for desirability, feasibility, viability, and traction. Judges are instructed to identify your next highest-risk assumption, not just score you.",
      },
      {
        q: "What happens between events?",
        a: "The program runs workshops, mentor office hours, and sprint sessions throughout the semester between events. Teams are expected to continue customer discovery, prototyping, and tool updates on their own sprint schedule. The program also facilitates an optional summer period with mentor check-ins, microgrant planning, and makerspace access for teams maintaining momentum before Year 2.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        a: "Sponsors can participate as named-prize providers, challenge-track hosts (posing a real industry problem for teams to solve), mentor contributors, event underwriters for the Ideathon or Innovation Festival, or microgrant donors funding prototype budgets for qualifying teams. Recognition varies by contribution level and is formalized in a sponsor agreement.",
      },
      {
        q: "How does the program benefit sponsors?",
        a: "Sponsors gain early access to entrepreneurially-minded student talent, a structured pathway to recruit interns and full-time hires from the program's strongest participants, brand visibility across university audiences, and a meaningful community engagement story. Challenge-track sponsors also get student teams generating novel solutions to real industry problems.",
      },
      {
      ...
      },
      {
        ...
        a: "The program publishes a pilot-year retrospective report covering participation, retention, cross-disciplinary team rates, customer interviews completed, prototypes built, teams with external traction, alumni engagement hours, external competition participation, and ventures or projects launched. Sponsors receive a copy and named recognition in the acknowledgments.",
      },
      {
        q: "What is the governance and oversight structure?",
        a: "Startup Launchpad operates under the Smith Center for Entrepreneurship, with a Program Director responsible for day-to-day coordination. Center leadership and the Dean's office provide strategic oversight. An advisory group of faculty, mentor, and alumni representatives is convened at least once per academic year to review outcomes and program direction.",
      },
      {
        q: "How does the budget work and who controls spending?",
        a: "The program operates under a university-managed budget controlled by the Program Director and Center leadership. Sponsor contributions are received through the university's standard gift or sponsorship agreement process. Microgrant disbursements are governed by a written policy covering eligibility, amounts, and reporting requirements.",
      },
      {
        q: "Can the program accommodate a custom challenge track for our industry?",
        a: "Yes. Challenge tracks are one of the most popular sponsor participation models. Your organization poses a real problem, and student teams who choose that track have access to industry mentors, relevant data, and a named prize for the top solution. The Program Director manages the challenge brief, judging coordination, and event logistics.",
      },
      {
        q: "What happens if the pilot year results are below expectations?",
        a: "The program is explicitly designed with a pilot-year retrospective and decision point built in. At the end of the first academic year, program leadership and key stakeholders review outcomes against defined success metrics and make one of three decisions: expand (scale cohort, add resources), modify (adjust model), or discontinue (conclude with documented learnings). Sponsors are informed of this decision point before they commit.",
      },
      {
        q: "How does the program handle equity and access?",
        a: "The program uses a multi-track entry model and rolling open enrollment specifically to lower barriers. There are no application fees, GPA requirements, or prerequisite courses. Workshop facilitation and mentor matching are available in multiple formats. The program tracks demographic participation data and reports on it in the annual retrospective to identify and address access gaps.",
      },
      {
        q: "Who do I contact to start a conversation about involvement?",
        a: "Reach out to the Program Director at the Smith Center for Entrepreneurship. For senior-level conversations, the Center Director is the appropriate contact. All initial inquiries — whether about sponsorship, mentoring, judging, faculty partnership, or administrative coordination — can begin with the Program Director, who will route them appropriately.",
      },
    ],
  },
];
...
function SectionTOC({ active, totalResults }: { active: string; totalResults: number }) {
        ...
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row gap-8 items-start sm:items-end justify-between">
          <div>
            ...
            <p className="text-[#8A99AA] text-base max-w-xl leading-relaxed">
              ...
              and administrators. Can't find what you're looking for? Contact
